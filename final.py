    ...
    console.print(
        Panel(
            Align.center(
                ...
                "[bright_cyan]Real Git Updater • Multi Tool System • Stable Downloader[/bright_cyan]"
            ),
...
def funny_hack_mode():
    ...
    for stage in stages:
        ...
        console.print(get_banner())
        console.print(Panel(
            Align.center(f"[bold bright_cyan]{stage}[/bold bright_cyan]"),
            border_style="bright_magenta",
    ...
    console.print(
        Panel(
            Align.center(
                ...
                "[bold bright_magenta]Black-Screen Fix Applied[/bold bright_magenta]"
            ),
...
def get_stream_candidates(info: dict):
    ...
    # Normal first for better compatibility
...
def optimize_with_ffmpeg(src_path: str) -> str:
    # Disabled to avoid black-screen issue
    return src_path
...
def download_video(tiktok_url: str):
    ...
    show_video_info(title, "Normal / HD Auto Fallback")
    prep_animation()
